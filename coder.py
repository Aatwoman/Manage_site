...
// Grab elements safely from the DOM.
const svg = document.getElementById("canvas");

// Early return guard: Prevents script execution if elements are not ready, 
// or if the initialization listeners have already been bound.
...
const boundarySidesInput = document.getElementById("boundarySides");
